import { Matrix, InvertedChildren, AnimateFlippedElementsArgs } from './types';
import { BoundingClientRect } from '../getFlippedElementPositions/types';
export declare const convertMatrix3dArrayTo2dArray: (matrix: Matrix) => Matrix;
export declare const convertMatrix2dArrayToString: (matrix: Matrix) => string;
